...
```javascript
text = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-moby-dick@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-moby-dick@umd/bundle.js"></script>
```
